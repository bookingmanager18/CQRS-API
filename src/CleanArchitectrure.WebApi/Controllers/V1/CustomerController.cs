...
using MediatR;
using GBSPlans.Application.UseCases.Customers.Queries.GetAllCustomerQuery;
using GBSPlans.Application.UseCases.Customers.Queries.GetByIdCustomerQuery;
using GBSPlans.Application.UseCases.Customers.Queries.GetAllWithPaginationCustomerQuery;
...
using GBSPlans.Application.UseCases.Customers.Commands.DeleteCustomerCommand;

namespace GBSPlans.WebApi.Controllers.V1
{
